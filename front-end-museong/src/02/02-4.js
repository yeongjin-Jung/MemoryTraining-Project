...
const arr6 = arr5.slice(0, 1); // arr6 = [1]

const [first, ...arr7] = arr5; // arr7 = [2, 3]
const obj3 = { name: '내이름', age: 20 }; // obj3 = {name: '내이름', age: 20}
const objValue = { name: '새이름', age: obj3.age }; // objValue = {name: '새이름', age: 20}
